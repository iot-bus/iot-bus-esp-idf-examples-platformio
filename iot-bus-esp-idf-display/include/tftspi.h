...
// ** Set the correct configuration for IoT-Bus Display
// ---------------------------------------------------------
...
#define PIN_NUM_TCS  16		// Touch screen CS pin (NOT used if USE_TOUCH=0)

#define PIN_NUM_RST  0  	// GPIO used for RESET control (#16)
#define PIN_NUM_BCKL 33  	// GPIO used for backlight control
